...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAWMATERIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_RAWMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RAWMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RAWMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RAWMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RAWMATERIAL actions', async () => {
      const expectedActions = [
        {
