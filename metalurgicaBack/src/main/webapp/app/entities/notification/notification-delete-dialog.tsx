...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="metalurgicaBckApp.notification.delete.question">
        <Translate contentKey="metalurgicaBckApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
