...
export const EmployeeDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(employeeEntity.name));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="metalurgicaBckApp.employee.delete.question">
        <Translate contentKey="metalurgicaBckApp.employee.delete.question" interpolate={{ id: employeeEntity.name }}>
