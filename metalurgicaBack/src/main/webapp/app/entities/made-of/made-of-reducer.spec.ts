...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './made-of.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MADEOF_LIST actions', async () => {
    ...
    it('dispatches FETCH_MADEOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MADEOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MADEOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MADEOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MADEOF actions', async () => {
      const expectedActions = [
        {
