...
export const AdminUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...adminEntity,
          emloyee: adminEntity?.emloyee?.name,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="metalurgicaBckApp.admin.home.createOrEditLabel" data-cy="AdminCreateUpdateHeading">
            <Translate contentKey="metalurgicaBckApp.admin.home.createOrEditLabel">Create or edit a Admin</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="emloyee"
                data-cy="emloyee"
                label={translate('metalurgicaBckApp.admin.emloyee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
