...
import { getEntity, deleteEntity } from './sales-person.reducer';
...
export const SalesPersonDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="metalurgicaBckApp.salesPerson.delete.question">
        <Translate contentKey="metalurgicaBckApp.salesPerson.delete.question" interpolate={{ id: salesPersonEntity.id }}>
