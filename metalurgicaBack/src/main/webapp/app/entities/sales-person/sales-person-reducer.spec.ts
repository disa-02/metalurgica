...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESPERSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESPERSON actions', async () => {
      const expectedActions = [
        {
