...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './subscribe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIBE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIBE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIBE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIBE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIBE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIBE actions', async () => {
      const expectedActions = [
        {
