...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './roow.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOW_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOW actions', async () => {
      const expectedActions = [
        {
