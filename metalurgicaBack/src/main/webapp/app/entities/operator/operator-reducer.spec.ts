...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './operator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERATOR actions', async () => {
      const expectedActions = [
        {
