...
export const OperatorUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...operatorEntity,
          emloyee: operatorEntity?.emloyee?.name,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="metalurgicaBckApp.operator.home.createOrEditLabel" data-cy="OperatorCreateUpdateHeading">
            <Translate contentKey="metalurgicaBckApp.operator.home.createOrEditLabel">Create or edit a Operator</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="emloyee"
                data-cy="emloyee"
                label={translate('metalurgicaBckApp.operator.emloyee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
