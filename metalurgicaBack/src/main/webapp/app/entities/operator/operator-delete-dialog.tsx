...
export const OperatorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="metalurgicaBckApp.operator.delete.question">
        <Translate contentKey="metalurgicaBckApp.operator.delete.question" interpolate={{ id: operatorEntity.id }}>
