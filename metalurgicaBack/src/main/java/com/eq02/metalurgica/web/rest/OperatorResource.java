...
/**
 * REST controller for managing {@link com.eq02.metalurgica.domain.Operator}.
 */
@RestController
@RequestMapping("/api")
public class OperatorResource {
    ...
    public ResponseEntity<Operator> updateOperator(
        ...
        Operator result = operatorService.update(operator);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Operator> partialUpdateOperator(
        ...
        Optional<Operator> result = operatorService.partialUpdate(operator);
