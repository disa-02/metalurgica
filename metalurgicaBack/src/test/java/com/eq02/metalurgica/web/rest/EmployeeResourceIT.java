...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().tipo(DEFAULT_TIPO).email(DEFAULT_EMAIL);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().tipo(UPDATED_TIPO).email(UPDATED_EMAIL);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getTipo()).isEqualTo(DEFAULT_TIPO);
    ...
    void getEmployee() throws Exception {
        ...
        // Get the employee
        restEmployeeMockMvc
            .perform(get(ENTITY_API_URL_ID, employee.getName()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void putExistingEmployee() throws Exception {
        ...
        // Update the employee
        Employee updatedEmployee = employeeRepository.findById(employee.getName()).get();
        // Disconnect from session so that the updates on updatedEmployee are not directly saved in db
        em.detach(updatedEmployee);
        updatedEmployee.tipo(UPDATED_TIPO).email(UPDATED_EMAIL);

        restEmployeeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEmployee.getName())
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getTipo()).isEqualTo(UPDATED_TIPO);
    ...
    void putNonExistingEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, employee.getName())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.setName(employee.getName());

        partialUpdatedEmployee.email(UPDATED_EMAIL);

        restEmployeeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedEmployee.getName())
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.tipo(UPDATED_TIPO).email(UPDATED_EMAIL);
    ...
    void patchNonExistingEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, employee.getName())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(employee))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteEmployee() throws Exception {
        ...
        // Delete the employee
        restEmployeeMockMvc
            .perform(delete(ENTITY_API_URL_ID, employee.getName()).accept(MediaType.APPLICATION_JSON))
