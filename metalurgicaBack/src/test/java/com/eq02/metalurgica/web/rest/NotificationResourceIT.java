...
class NotificationResourceIT {
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification().descripcion(DEFAULT_DESCRIPCION).tipo(DEFAULT_TIPO);
        return notification;
    }
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        Notification notification = new Notification().descripcion(UPDATED_DESCRIPCION).tipo(UPDATED_TIPO);
        return notification;
    }
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getDescripcion()).isEqualTo(DEFAULT_DESCRIPCION);
        assertThat(testNotification.getTipo()).isEqualTo(DEFAULT_TIPO);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.descripcion(UPDATED_DESCRIPCION).tipo(UPDATED_TIPO);
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
        assertThat(testNotification.getTipo()).isEqualTo(UPDATED_TIPO);
    }
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.descripcion(UPDATED_DESCRIPCION).tipo(UPDATED_TIPO);
