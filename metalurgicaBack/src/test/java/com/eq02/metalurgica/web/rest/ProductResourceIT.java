...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).stock(DEFAULT_STOCK).buyPrice(DEFAULT_BUY_PRICE).sellPrice(DEFAULT_SELL_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).stock(UPDATED_STOCK).buyPrice(UPDATED_BUY_PRICE).sellPrice(UPDATED_SELL_PRICE);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).stock(UPDATED_STOCK).buyPrice(UPDATED_BUY_PRICE).sellPrice(UPDATED_SELL_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).stock(UPDATED_STOCK).buyPrice(UPDATED_BUY_PRICE).sellPrice(UPDATED_SELL_PRICE);
